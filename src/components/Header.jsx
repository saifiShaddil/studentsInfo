...
const Header = () => {
  return (
    <nav class="bg-white absolute w-[100%] border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
      <div class="ml-60 flex flex-wrap justify-between items-center mx-auto">
